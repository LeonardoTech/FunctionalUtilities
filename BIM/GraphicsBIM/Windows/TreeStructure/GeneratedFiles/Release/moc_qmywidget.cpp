...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMyWidget_t, stringdata) + ofs \
...
const QMetaObject QMyWidget::staticMetaObject = {
    { &osgQt::GLWidget::staticMetaObject, qt_meta_stringdata_QMyWidget.data,
...
void *QMyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMyWidget.stringdata))
        return static_cast<void*>(const_cast< QMyWidget*>(this));
    return osgQt::GLWidget::qt_metacast(_clname);
}

int QMyWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = osgQt::GLWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}

...
MeasuringLineLength::MeasuringLineLength(Selector *select1, Selector *select2)
{
	_select1 = select1;
	_select2 = select2;
...
osgText::Text * MeasuringLineLength::createText()
{
...
// brief	<创建线，没有设置顶点的坐标>
osg::Geode* MeasuringLineLength::createLine()
{
...
void MeasuringLineLength::setRoot(osg::Group* node)
{
	_root = node;
...
void MeasuringLineLength::setLabel(string name, float x, float y)
{
